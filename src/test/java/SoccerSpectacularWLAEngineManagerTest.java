...
public class SoccerSpectacularWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(SoccerSpectacularWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/SoccerSpectacularWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/SoccerSpectacularWLAIW/InitOutcome.xml").getDocumentElement();
